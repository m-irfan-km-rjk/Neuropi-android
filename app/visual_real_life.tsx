...
export default function VisualRealLifeScreen() {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Visual Real-Life</Text>
            </View>
...
const styles = StyleSheet.create({
    ...
    homeButton: { backgroundColor: '#90CAF9', padding: 15, borderRadius: 8, marginRight: 20 },
